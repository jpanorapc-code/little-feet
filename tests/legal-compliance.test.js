...
assert.match(page, /assets\/legal-notices\.js\?v=20260926-legal-v3/);

assert.match(server, /LITTLE_FEET_PRIVACY_VERSION = 'POPIA-2026-09-v4'/);
assert.match(server, /LITTLE_FEET_TERMS_VERSION = 'TOS-ZA-2026-09-v4'/);
...
assert.match(legal, /Christiaan@littleFeet\.co\.za/);
assert.match(legal, /062 943 2244/);
assert.match(legal, /tel:\+27629432244/);
assert.match(legal, /does not publish a company registration number, registered office or Information Officer registration detail unless that detail actually exists and has been verified/);
...
assert.match(sw, /assets\/legal-notices\.js\?v=20260926-legal-v3/);
