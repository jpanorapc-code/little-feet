...
assert.match(cinematic, /const waterInterval = quality === 'high' \? 1 \/ 18/);
assert.match(cinematic, /const worldInterval = quality === 'high' \? 1 \/ 30/);
assert.match(cinematic, /const bubbleInterval = quality === 'high' \? 1 \/ 24/);
