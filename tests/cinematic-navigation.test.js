...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v11" defer/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v11'\)/);
