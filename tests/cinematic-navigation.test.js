...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v32" defer/);
...
assert.match(cinematic, /safe-webgl-v9-raster-depth-backdrop/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v9-raster-depth-backdrop'/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v32'\)/);
