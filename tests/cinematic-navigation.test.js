...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v28" defer/);
...
assert.match(cinematic, /safe-webgl-v5-scroll-hold-batched-particles/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v5-scroll-hold-batched-particles'/);
...
assert.match(cinematic, /MAX_RENDER_PIXELS = 1280 \* 720/);
...
assert.match(cinematic, /pixelBudgetRatio = Math\.sqrt\(MAX_RENDER_PIXELS \/ cssPixels\)/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v28'\)/);
