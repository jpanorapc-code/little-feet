...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v34" defer/);
...
assert.match(cinematic, /safe-webgl-v12-compact-realism/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v12-compact-realism'/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v34'\)/);
