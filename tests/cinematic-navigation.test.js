...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v6" defer/);
...
assert.match(cinematic, /headYaw = pointer\.smoothX \* \.94/);
assert.match(cinematic, /eyeX = pointer\.smoothX \* \.145/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v6'\)/);
