...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v22" defer/);
...
assert.match(cinematic, /backgroundPause = 'offscreen-hard-stop-v1'/);
...
assert.match(cinematic, /renderer\.setPixelRatio\(Math\.min\(window\.devicePixelRatio \|\| 1, \.85\)\)/);
assert.match(cinematic, /renderer\.setPixelRatio\(1\)/);
assert.match(cinematic, /minFrameMs = 1000 \/ renderFpsCap/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v22'\)/);
