...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v4" defer/);
...
assert.match(cinematic, /headYaw = pointer\.smoothX \* \.72/);
assert.match(cinematic, /eyeX = pointer\.smoothX \* \.115/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v4'\)/);
