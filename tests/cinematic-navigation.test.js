...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v20" defer/);
...
assert.match(cinematic, /performanceMode = 'adaptive-frame-time-v1'/);
assert.match(cinematic, /renderFpsCap = 60/);
assert.match(cinematic, /renderFpsCap = 45/);
assert.match(cinematic, /averageMs > 23/);
assert.match(cinematic, /averageMs > 18\.5/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v20'\)/);
