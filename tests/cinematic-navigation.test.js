...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v33" defer/);
...
assert.match(cinematic, /safe-webgl-v10-clean-2d-depth-waterline/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v10-clean-2d-depth-waterline'/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v33'\)/);
