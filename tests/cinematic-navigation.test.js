...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v31" defer/);
...
assert.match(cinematic, /safe-webgl-v8-slow-scroll-pause-depth2d/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v8-slow-scroll-pause-depth2d'/);
...
assert.match(page, /cinematic-portrait-backdrop/);
assert.match(styles, /height: 680vh/);
assert.match(styles, /cinematic-portrait-backdrop/);
...
assert.match(cinematic, /portraitBackdrop\.style\.transform/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v31'\)/);
