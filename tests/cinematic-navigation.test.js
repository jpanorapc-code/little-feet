...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v29" defer/);
...
assert.match(cinematic, /safe-webgl-v6-display-adaptive/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v6-display-adaptive'/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v29'\)/);
