...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v27" defer/);
...
assert.match(cinematic, /safe-webgl-v4-trimmed-animation/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v4-trimmed-animation'/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v27'\)/);
