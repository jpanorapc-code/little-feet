...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v14" defer/);
...
assert.match(cinematic, /waterUpdateCount % 8 === 0/);
assert.match(cinematic, /updateHeavyWorld = quality === 'high' \|\| worldFrame % 2 === 0/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v14'\)/);
