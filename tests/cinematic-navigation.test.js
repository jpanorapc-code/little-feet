...
assert.match(page, /src="\/assets\/cinematic-loader\.js\?v=20260924-cinematic-v25" defer/);
...
assert.match(cinematic, /safe-webgl-v3-procedural-mascot/);
...
assert.match(cinematic, /compressionProfile = 'safe-webgl-v3-procedural-mascot'/);
...
assert.match(cinematic, /effectiveFpsCap = idle \? 6 : renderFpsCap/);
...
assert.match(cinematic, /sourceSwimAction = null/);
...
assert.match(cinematic, /const sourceBlend = 0/);
...
assert.match(cinematicLoader, /import\('\/assets\/cinematic\.js\?v=20260924-cinematic-v25'\)/);
