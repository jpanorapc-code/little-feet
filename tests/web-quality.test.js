...
assert.match(page, /body\.light-mode \.app-sidebar::before \{/);
assert.match(page, /rgba\(27,73,101,\.58\)/);
assert.doesNotMatch(page.match(/body\.light-mode \.app-sidebar::before \{[\s\S]*?\}/)?.[0] || '', /#07111e/);
