...
assert.match(page, /class="portal-aurora-strobes"/);
assert.match(page, /class="wallpaper-aurora-strobes"/);
assert.match(page, /@keyframes auroraStrobeSweep/);
assert.match(page, /@keyframes auroraStrobeSweepReverse/);
assert.match(page, /@keyframes auroraStrobeGlow/);
