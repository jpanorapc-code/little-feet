...
assert.match(page, /Academic Term 1: Active Session \| Campus Hours: 07:00 - 17:30 SAST/);
assert.match(page, /\.nav-term-panel strong \{[\s\S]*white-space:normal !important/);
assert.match(page, /\.nav-quickbar \.nav-shortcut \{[\s\S]*align-self:flex-start !important/);
